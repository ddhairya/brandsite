...
export const Feedback = () => {
    ...
    //const [checkbx, setCheckbx] = useState('')
    ...
    const submit = (event) =>{
        ...
        //setEmail(...email,handleOnChangeEmail(event.target.value))
        // setLoc({loc: [event.target.loc.value]})
        // setTime({time: [event.target.value] })
        // setname({fname: [event.target.value] })
        // setMob({mob: [event.target.value] })
        // setEmail(event.target.email.value)
        // setQ1({q1: [event.target.value] })
        // setQ2({q2: [event.target.value] })
        // setQ3({q3: [event.target.value] })
        // setQ4({q4: [event.target.value] })
        // setRb({rb: [event.target.value] })
        // setComment({comment: [event.target.value] })
        // setCheckbx({checkbx: [event.target.checked] })
        // //setRange1({range1: [event.target.value]})
        ...
        //setFeedback({feedback:[feedbackObj]})
        
        //Feedbck(feedbackObj)

        //setFeedback({[event.target.name]:[event.target.value]})
        //console.log(feedbackObj)
        ...
        <Jumbotron>
            ...
            <Form className = 'feed' onSubmit={submit}>            
                ...
                <Form.Group as = {Row} controlId="formBasicRangeQ1">
                    ...
                    <Col className="rangeValueL" sm="1">
                    Excelent
                    </Col>
                </Form.Group>
